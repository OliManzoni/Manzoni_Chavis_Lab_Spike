...
if uploaded_file is not None:
    ...
    try:
        ...
        # DÉTECTION AUTOMATIQUE DU PULSE (Robuste)
        ...
        try:
            ...
            # Fallback si pas de pulse détecté
        ...
        if os.path.exists(tmp_filepath): os.remove(tmp_filepath)import streamlit as st
import pyabf
import numpy as np
import pandas as pd
import matplotlib.pyplot as plt
